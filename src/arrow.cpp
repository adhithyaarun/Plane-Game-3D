...
Arrow::Arrow(float x, float y, float z, float angle_x, float angle_y, float angle_z, color_t color)
{
...
void Arrow::set_angle(float angle_x, float angle_y, float angle_z)
{
    this->rotation_x = angle_x;
    this->rotation_y = angle_y;
    this->rotation_z = angle_z;
